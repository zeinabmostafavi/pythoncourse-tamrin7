...
print('(', result.sorat1, '/', result.makhrag1, ')*(',
      result.sorat2, '/', result.makhrag2, ')=', result.mul())

print('(', result.sorat1, '/', result.makhrag1, ')+(',
      result.sorat2, '/', result.makhrag2, ')=', result.sum())

print('(', result.sorat1, '/', result.makhrag1, ')-(',
      result.sorat2, '/', result.makhrag2, ')=', result.sub())

print('(', result.sorat1, '/', result.makhrag1, ')/(',
      result.sorat2, '/', result.makhrag2, ')=', result.div())
...
class time():
    ...
    def sum_time(self):
        ...
        print("your second time", self.hour1, ":",
              self.minute2, ":", self.second2)
